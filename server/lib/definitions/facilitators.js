...
exports.makeRare = (type, level) => {
    ...
    return {
        PARENT: "food",
        LABEL: ["Shiny", "Legendary", "Shadow", "Rainbow", "Trans", "Radiant"][level] + " " + type.LABEL,
        VALUE: [25, 100, 400, 1600, 6400, 25600][level] * type.VALUE,
        SHAPE: type.SHAPE,
        SIZE: type.SIZE,
        GLOW:  {
            RADIUS: 2,
            STRENGTH: 25,
            COLOR: ["rainbow", "rainbow", "rainbow", "rainbow", "trans", "rainbow"][level],
            ALPHA: 0.6
        },
        COLOR: ["rainbow", "rainbow", "rainbow", "rainbow", "trans","rainbow"][level],
        ALPHA: level == 2 ? 0.25 : 1,
        BODY: {
            DAMAGE: [1, 1, 2, 2.5, 2.5, 25][level] * type.BODY.DAMAGE,
            DENSITY: [1, 1, 2, 2.5, 2.5, 25][level] * type.BODY.DENSITY,
            HEALTH: [2, 4, 4, 6, 8, 25][level] * type.BODY.HEALTH,
            PENETRATION: [1.5, 1.5, 2, 2.5, 2.5, 25][level] * type.BODY.PENETRATION,
...
exports.makeLaby = (type, tier, rarity, level, baseScale = 1) => {
    ...
    return {
        PARENT: 'food',
        LABEL: ['', 'Beta ', 'Alpha ', 'Omega ', 'Gamma ', 'Delta ', 'Ultra ', 'Mythic ', 'Transcendent ', 'Otherworldly ', 'King '][level] + type.LABEL,
